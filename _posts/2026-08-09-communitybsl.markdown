...
download_url: https://github.com/1c-syntax/sonar-bsl-plugin-community/releases/download/v1.20.0/sonar-communitybsl-plugin-1.20.0.jar
download_version: 1.20.0
download_description: New bsl-language server version, performance optimization
download_date: 2026-08-09
license: GNU LGPL v3
developers: Alexey Sosnoviy, Nikita Fedkin
sonarqube_version: 2025.4.1-LATEST
category: languages
