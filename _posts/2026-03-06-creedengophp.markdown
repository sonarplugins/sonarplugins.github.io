...
download_url: https://github.com/green-code-initiative/creedengo-php/releases/download/2.1.0/creedengo-php-plugin-2.1.0.jar
download_version: 2.1.0
download_description: compatibility updates for SonarQube 26.3.0; upgrade libraries versions; technical optimizations
