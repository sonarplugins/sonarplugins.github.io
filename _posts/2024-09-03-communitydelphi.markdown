...
download_url: https://github.com/integrated-application-development/sonar-delphi/releases/download/v1.9.0/sonar-delphi-plugin-1.9.0.jar
download_version: 1.9.0
download_description: Improvements to VariableInitialization and RedundantParentheses, type inference improvements, parsing improvements, bug fixes
download_date: 2024-09-03
license: GNU LGPL 3
