...
download_url: https://github.com/integrated-application-development/sonar-delphi/releases/download/v1.10.0/sonar-delphi-plugin-1.10.0.jar
download_version: 1.10.0
download_description: 1 new rule, improvements to RedundantParentheses, bug fixes
