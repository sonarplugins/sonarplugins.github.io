...
download_url: https://github.com/integrated-application-development/sonar-delphi/releases/download/v1.11.0/sonar-delphi-plugin-1.11.0.jar
download_version: 1.11.0
download_description: 1 new rule, improvements to procedural type handling, bug fixes
